<?php
function mytheme_enqueue_settings_assets() {
    ...
    wp_enqueue_style( 'mytheme-page-setting', get_theme_file_uri( 'styles/profile/settings.css' ), array(), wp_get_theme()->get( 'Version' ) );
...
add_action( 'wp_enqueue_scripts', 'mytheme_enqueue_settings_assets' );
