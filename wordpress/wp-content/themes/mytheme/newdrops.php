...
?>
	<main>
        ...
        <section class="banner">
            <img src="<?php echo esc_url( get_theme_file_uri( 'assets/Background_newdrops.png' ) ); ?>" alt="">
        </section>
                    ...
                    array(
                        ...
                        'tax_query'      => array(
                            array(
                                ...
                                'field'    => 'slug',
                                'terms'    => array( 'new-drops', 'newdrops', 'new-arrivals' ),
                            ),
                        ),
                    )
                );

                if ( $newdrop_products->have_posts() ) :
                    while ( $newdrop_products->have_posts() ) :
                        $newdrop_products->the_post();
