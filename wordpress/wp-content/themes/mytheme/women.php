...
?>
	<main>
        ...
        <section class="banner">
            <img src="<?php echo esc_url( get_theme_file_uri( 'assets/Background_women.png' ) ); ?>" alt="">
        </section>
        <section class="content">
            ...
            <div class="product_sale_cons">
                ...
                if ( $women_products->have_posts() ) :
                    while ( $women_products->have_posts() ) :
                        $women_products->the_post();
